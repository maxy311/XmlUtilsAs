...
public class GetSHAREitTranslate2 {
    private static final String LAST_TAG = "v5.1.68_ww";
    ...
    private static File getModuleFile(String module, boolean isZHFile) {
    ...
    private static File getDesktopShareitFile() {
        ...
        File shareitFile = new File(file, "SHAREit_Translate");
